                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Debtor Processed Payments</h5>
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb-title">
                                            ...
                                            <li class="breadcrumb-item"><a href="debtor_processed_payment.php">Processed Debtor Payment</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                ...
                                                <form action="finance_csv_handler.php" method="POST">
                                                    <div class="form-group row">
                                                        <div class="col-sm-3">
                                                            ...
                                                            <button class="ti-download btn btn-success btn-mat " id='debtor_processed_filter' name='debtor_processed_filter'> CSV</button>
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            <?php
                                                                                ...
                                                                                $sql = "SELECT `transaction_ID`, `type`, `action_name`, `action_ID`, `C_D_ID`, `amount`,
                                                                                 `trans_date`, `trans_time`, `trans_status`, `user_ID` FROM `transaction` WHERE `trans_status` = 'fully_payed' AND `type` !='creditor_buy_back'";
