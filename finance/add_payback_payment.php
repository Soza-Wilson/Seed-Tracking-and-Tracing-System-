                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Add Payback Payment</h5>
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb-title">
                                            ...
                                            <li class="breadcrumb-item"><a href="add_payback_payment.php">Add payback Payment</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="card">
                                                   ...
                                                   <tr class='odd gradeX'>
                                                       ...
                                                       <td><a href='view_creditor_transaction_details.php? order_id=$action_id&trans_id=$trans_ID&debitor_id=$debtor_id&trans_date=$date&trans_time=$time&trans_amount=$amount&trans_type=$type&creditor_id=$creditor_id&status=$status' class='btn btn-success'>View</a></td>
                                                   </tr>	
                                               ";
                                                                                    }
                                                                                }
                                                   ...
                                                   <tr class='odd gradeX'>
                                                       ...
                                                       <td><a href='#? order_id=$action_id&trans_id=$trans_ID&debitor_id=$debtor_id&trans_date=$date&trans_time=$time&trans_amount=$amount&trans_type=$type&debtor_id=$debtor_id&status=$status' class='btn btn-success'>View</a></td>
                                                   </tr>	
                                               ";
                                                                                    }
                                                                                }
