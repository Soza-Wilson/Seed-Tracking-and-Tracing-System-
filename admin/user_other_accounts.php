                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Inactive Users </h5>
                                            <p class="m-b-0"></p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb-title">
                                            ...
                                            <li class="breadcrumb-item"><a href="view_registered_users.php">Inactive users </a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-hover">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <?php
                                                                    $profile = "";
                                                                    $sql = "SELECT `user_ID`, `fullname`, `DOB`, `sex`, `registered_date`,
                                                                     `postion`, `phone`, `email`, `password`, `account_status`, `profile_picture` FROM `user` WHERE `account_status`!='active'
                                                                    ";
                                                                    ...
                                                                    if ($result->num_rows > 0) {
                                                                        while ($row = $result->fetch_assoc()) {
                                                                            ...
                                                                            if ($row["account_status"] == "unsigned") {

                                                                                $status = ["inverse", "unassigned"];
                                                                            }


                                                                            if ($row["account_status"] == "suspended") {

                                                                                $status = ["danger", "suspended"];
                                                                            }
                                                                            ...
                                                                            <td>$email</td>
                                                                            <td>$date</td>
                                                                            <td class='text-left'><label class='label label-$status[0]'>$status[1]</label></td>
                                                                            
                                                                            <td><a href='view_user_details.php?user_id=$user_id&name=$name&depertment=-&position=$position&phone=$phone&email=$email&date=$date&profile_picture=$profile'class='btn btn-success btn-mat'><i class='icofont icofont-eye-alt'></i></a>
                                                                        </tr>";
                                                                        }
                                                                    }
                                                                    ?>
