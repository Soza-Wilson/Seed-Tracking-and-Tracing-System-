                                                        ...
                                                        <div class="card-block ">
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <div class="col-sm-12"><label class="label bg-primary"> Business name</label></div>
                                                                        <div class="col-sm-12">
                                                                            <input type="text" class="form-control" id="business_name" required="" placeholder="Business Name" value="<?php if($address!="-"){echo $business_name;}?>">
                                                                        </div >
                                                                        ...
                                                                        <div class="col-sm-12">
                                                                            <input type="text" class="form-control" id="country" required="" placeholder="Enter Country name" value="<?php if($address!="-"){echo $country;}?>">
                                                                        </div >
                                                                    ...
                                                                    <div class="form-group row">
                                                                        ...
                                                                        <div class="col-sm-12">
                                                                                ...
                                                                                <textarea rows=7 type="address" class="form-control internal" required="" id="physical_address" placeholder="Format: TITLE/ P.O BOX 0000/  CITY NAME/ AREA ( This will be disprayed on all documents generated by the system.)"><?php if($address!="-"){echo $address;}?></textarea>
                                                                        </div>
                                                                    </div>
