                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb-title">
                                            ...
                                            <li class="breadcrumb-item"><a href="admin_processed_orders.php">Processed Orders </a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div class="page-body">
                                        ...
                                        <div class="card">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            `customer_name`, `order_book_number`, `status`, `date`, `time`, `count`,
                                                             `total_amount` FROM `order_table` INNER JOIN user ON order_table.user_ID = user.user_ID
                                                              WHERE order_table.status = 'processed'";
											...
											<tr class='odd gradeX'>
												...
												<td><a href='view_order_items.php? order_ID=$order_ID' class='btn btn-success'>view</a></td>
											</tr>	
										";
                                                                }
                                                            }
