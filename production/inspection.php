                                ...
                                <ul class="pcoded-item pcoded-left-item">
                                    <li class="pcoded-hasmenu active">
                                        <a href="javascript:void(0)" class="waves-effect waves-dark">
                                            <span class="pcoded-micon"><i class="ti-car"></i><b>M</b></span>
                                            <span class="pcoded-mtext" data-i18n="nav.menu-levels.main">Inspection</span>
                                            <span class="pcoded-mcaret"></span>
                                        </a>
                                        <ul class="pcoded-submenu">
                                            <li class="active">
                                                <a href="javascript:void(0)" class="waves-effect waves-dark">
                                                    ...
                                                    <span class="pcoded-mtext" data-i18n="nav.menu-levels.menu-level-21">Add inspection</span>
                                                    <span class="pcoded-mcaret"></span>
                                                </a>
                                            </li>
                                            ...
                                            <li class="">
                                                <a href="javascript:void(0)" class="waves-effect waves-dark">
                                                    <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                    <span class="pcoded-mtext" data-i18n="nav.menu-levels.menu-level-23">view added inspections</span>
                                                    <span class="pcoded-mcaret"></span>
                                                </a>
                                            </li>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb-title">
                                            ...
                                            <li class="breadcrumb-item"><a href="view_registered_users.php">Add inspection</a>
                                            </li>
                            ...
                            <div class="main-body">
                              ...
                              `other_year_crop`, `main_lot_number`, `main_quantity`, `male_lot_number`,
                               `male_quantity`, `female_lot_number`, `female_quantity` FROM `farm`
                                ...
                                variety ON farm.variety = variety.variety_ID INNER JOIN creditor
									...
									{    $farm_id= $row['farm_ID'];
										...
										echo"
											<tr class='odd gradeX'>
												...
												<td><a href='view_registered_users.php' class='btn btn-success'>Add</a>
