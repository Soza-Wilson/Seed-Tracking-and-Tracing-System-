                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb-title">
                                            ...
                                            <li class="breadcrumb-item"><a href="view_registered_users.php">view users</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                                         ...
                                                         <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                             <h5 class="modal-title">Register new grower</h5>
                                                                ...
                                                                <div class="form-group row">
                                                                            ...
                                                                            <div class="col-sm-12">
                                                                                <input id="creditor_name" type="text" class="form-control" name="creditor_name"
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-sm-12">
                                                                                <input id="creditor_phone" type="text" class="form-control" name="creditor_phone"
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-sm-12">
                                                                                <input id="creditor_email" type="text" class="form-control" name="creditor_email"
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <labe>Supporting documents :</label>
                                                                                <input id="supporting_files" type="file" class="form-control" name="supporting_files"
                                                                                placeholder="Phone number" require="">
                                                                            </div>
                                            ...
                                            <div class="card-block table-border-style">
                                                <div class="table-responsive">
                                                    <table class="table table-hover">
                                                        ...
                                                        <?php
								$sql = "SELECT `crop`,`variety`,`pre_basic`,`basic`,`certified` 
                                FROM `crop` INNER JOIN variety ON crop.crop_ID = variety.crop_ID 
                                INNER JOIN price ON variety.variety_ID = price.variety_ID";
