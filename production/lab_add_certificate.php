                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Add crop certificate</h5>
                                            <p class="m-b-0"></p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb-title">
                                            ...
                                            <li class="breadcrumb-item"><a href="view_registered_users.php">Add crop certificate</a>
                                            </li>
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                ...
                                                <div class="card-block">
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-sm-12">
                                                            <select id="farm_grade" name="farm_grade" class="form-control">
