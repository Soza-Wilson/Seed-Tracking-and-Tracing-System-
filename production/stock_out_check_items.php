                ...
                <div class="pcoded-wrapper">
                    ...
                    <div class="pcoded-content">
                        ...
                        <div class="pcoded-inner-content">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h5> Already added from stock ( Remaining quantity : )</h5>
                                ...
                                <div class="card-block table-border-style">
                                    <div class="table-responsive">
                                        <table class="table table-hover">
                                            ...
                                            <td><a href='reverse_stock_out.php? item_ID=$item_ID & item_quantity=$quantity & stock_in_ID=$stock_in_id & stock_out_ID=$stock_out_id'  class='btn btn-danger'>Reverse</a> </td>
