                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb-title">
                                            ...
                                            <li class="breadcrumb-item"><a href="view_stock_in.php">View Inventory</a>
                                            </li>
                                                    ...
                                                    <table id="dataTable" class="table table-hover">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <?php
                                                                ...
                                                                $sql = "SELECT crop.crop,variety.variety, SUM(stock_in.available_quantity) AS quantity FROM stock_in INNER JOIN crop ON crop.crop_ID = stock_in.crop_ID INNER JOIN variety ON variety.variety_ID =stock_in.variety_ID GROUP BY variety.variety_ID";
