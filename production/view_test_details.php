                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb-title">
                                            ...
                                            <li class="breadcrumb-item"><a href="view_test_details.php">View Test Details</a>
                                            </li>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-block">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input type="number" id="defects" class="form-control" name="defects" placeholder="-" value="<?php echo $test_row['grade']; ?>" require="">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <a href="test_history.php"  class="btn waves-effect waves-light btn-info btn-mat"> <i class="ti ti-back"></i>Back</a>
