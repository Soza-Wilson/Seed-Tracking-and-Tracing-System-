...
<body>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <select id="farm_variety" name="farm_variety" class="form-control">
                                                                ...
                                                                <option value="<?php echo $data[8]; ?>"><?php echo $data[3]; ?></option>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <select id="farm_class" name="farm_class" class="form-control">
                                                                ...
                                                                <option value="0"><?php echo $data[5]; ?></option>
    ...
    if (isset($_POST['add_lab_test'])) {
        ...
        $germ_perc = $_POST['germination'];
        $shell_perc = $_POST['shelling'];
