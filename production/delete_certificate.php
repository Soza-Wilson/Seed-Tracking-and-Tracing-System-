...
<input id="approvalId" type="hidden" class="form-control" name="approvalId"  require="">
<div class="col-sm-12 confirm_group">

<input id="approvalCode" type="text" class="form-control" name="approvalId" placeholder="Approval code" require="">
...
<button type="button" id="delete_certificate" class="btn btn-danger btn-md btn-block waves-effect text-center m-b-20">Delete</button>

<input type="button" name="confirm_code" id="confirm_code" value="Confirm " class="btn btn-danger btn-md btn-block waves-effect text-center m-b-20 confirm_group" />

<input type="hidden" id="action_id" value="<?php  echo $_GET['lot_number']?>" >
<input type="hidden" id="request_id" value="<?php  echo $_GET['requested_id']?>">
<input type="hidden" id="request_name" value="<?php  echo $_GET['requested_name']?>">
<input type="hidden" id="certificate_quantity" value="<?php  echo $_GET['certificate_quantity']?>">
<input type="hidden" id="assigned_quantity" value="<?php  echo $_GET['assigned_quantity']?>">
<input type="hidden" id="available_quantity" value="<?php  echo $_GET['available_quantity']?>">
