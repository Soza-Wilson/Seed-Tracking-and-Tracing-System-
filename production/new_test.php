                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">New lab test</h5>
                                            <p class="m-b-0"></p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb-title">
                                            ...
                                            <li class="breadcrumb-item"><a href="view_registered_users.php">add lab test</a>
                                            </li>
                            ...
                            <div class="main-body">
                              ...
                              INNER JOIN variety on stock_in.variety_ID = variety.variety_ID WHERE status = 'uncertified'";
											...
											<tr class='odd gradeX'>
												...
												<td><a href='add_lab_test.php?ID=$stock_in_id' class='btn waves-effect waves-light btn-success btn-block'>add test results</a>
